...
function App() {
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>, type: keyof DocumentUpload) => {
        ...
        <div className="min-h-screen bg-black bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] p-6 flex items-center justify-center">
            <div className="w-full max-w-xl bg-zinc-900 rounded-2xl shadow-2xl shadow-purple-500/10 p-8 space-y-8 border border-zinc-800">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-white mb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">Health Profile</h1>
                    <p className="text-zinc-400">Please provide your basic health information</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-6">
                        ...
                        {/* Height */}
                        <div>
                            <label className="block text-sm font-medium text-zinc-300 mb-2">Height (inches)</label>
                            <div className="relative">
            ...
            <Dialog open={showDocumentUpload} onOpenChange={setShowDocumentUpload}>
                <DialogContent className="sm:max-w-[500px]">
                    ...
                    <form onSubmit={(e) => { handleDocumentSubmit(e); setDialog(true); }} className="space-y-6 mt-4">
                        <div className="space-y-6">
                            {/* Medical History */}
                            <div>
                                <label className="block text-sm font-medium text-zinc-300 mb-2">Existing Conditions</label>
                                <div className="relative">
                                    <textarea
                            ...
                            <div className="Ongo">
                                <label className="block text-sm font-medium text-zinc-300 mb-2">Ongoing Medications</label>
                                <div className="relative">
                                    <textarea
                                        className="w-full h-32 p-3 bg-zinc-800/50 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors text-white placeholder-zinc-500"
